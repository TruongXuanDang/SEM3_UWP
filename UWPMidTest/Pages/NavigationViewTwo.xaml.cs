...
namespace UWPMidTest.Pages
{
    ...
    /// </summary>
    public sealed partial class NavigationViewTwo : Page
    {
        public NavigationViewTwo()
        {
        ...
        {
            ("home", typeof(ShowSongList)),
            ("apps", typeof(ListOfSong)),
        };
        ...
        private void On_Navigated(object sender, NavigationEventArgs e)
        {
            ...
            if (ContentFrame.SourcePageType == typeof(ShowSongList))
            {
